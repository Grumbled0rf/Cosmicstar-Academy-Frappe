<template>
	...
	>
		<div class="flex space-x-4 mb-4">
			<div class="flex items-center justify-center w-12 h-12 rounded-full bg-white">
				<img
					v-if="job.company_logo"
					:src="job.company_logo"
					alt="Company Logo"
					class="size-8 rounded-full object-contain bg-white"
				/>
				<span v-else class="text-ink-gray-6 text-lg font-semibold">
		...
		<div class="space-x-2 mt-auto">ls
